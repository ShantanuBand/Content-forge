...
export function LogoIcon({ className = "w-6 h-6" }) {
  return (
    <svg className={className} width="28" height="28" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M10 16L14 12L18 16L14 20L10 16Z" fill="white" fillOpacity="0.9" />
      <path d="M14 20L18 16L22 20L18 24L14 20Z" fill="white" fillOpacity="0.6" />
      <path d="M14 12L18 8L22 12L18 16L14 12Z" fill="white" fillOpacity="0.4" />
      <defs>
...
export function SparklesIcon({ className = "", color = "currentColor" }) {
  return (
...
export function SliderIcon({ className = "" }) {
  return (
    <svg className={className} width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
